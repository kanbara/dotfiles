...
set fish_color_command 70c0b1
set fish_color_comment a7adba
set fish_color_cwd b9ca4a
set fish_color_cwd_root d54e53
set fish_color_end b9ca4a
set fish_color_error d54e53
set fish_color_escape 70c0b1
set fish_color_history_current 70c0b1
set fish_color_host '-o'  '70c0b1'
set fish_color_match 70c0b1
set fish_color_normal dfe1e8
set fish_color_operator 70c0b1
set fish_color_param c397d8
set fish_color_quote 7aa6da
set fish_color_redirection b9ca4a
set fish_color_search_match --background=c397d8
set fish_color_selection --background=c397d8
set fish_color_status d54e53
set fish_color_user '-o'  'b9ca4a'
set fish_color_valid_path --underline


# base16 shell
eval sh $HOME/.config/base16-shell/base16-yesterdaybright.dark.sh
